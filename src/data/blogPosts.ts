...
[Book a free visit](/en/contact) today.
  ...
  },
  {
    ...
    excerpt: "Οδηγός επιλογής κτήματος για γάμο στην Αθήνα και την Αττική: πρόσβαση, χωρητικότητα, parking, εκκλησίες και οι ερωτήσεις που αξίζει να κάνετε πριν κλείσετε.",
