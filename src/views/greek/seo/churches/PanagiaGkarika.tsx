...
export default function PanagiaGkarika() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Ναι! Η Παναγία Γκαρικά είναι ιδανική για ολιγομελείς γάμους με 30-40 καλεσμένους. Το μικρό μέγεθος του εκκλησιού δημιουργεί μια πολύ προσωπική και συγκινητική ατμόσφαιρα."
    },
    {
      question: "Υπάρχει χώρος για φωτογραφίσεις;",
      answer: "Βεβαίως. Το εκκλησάκι έχει όμορφο περιβάλλον με θέα και πολλά γραφικά σημεία για φωτογράφιση. Η εγγύτητα στη θάλασσα προσφέρει επιπλέον όμορφα φόντα."
    },
    {
        ...
        <div className="container-max">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="card-elegant p-8 mb-8">
              <h2 className="font-heading mb-6 text-gradient-brand">Το Εκκλησάκι</h2>
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                <p>
                  Η Παναγία Γκαρικά είναι ένα γραφικό εκκλησάκι στην Κερατέα, ιδανικό για ολιγομελείς γάμους.
            ...
            {/* Map */}
            <div className="card-elegant p-8 mb-8">
              <h2 className="font-heading mb-6 text-gradient-brand">Πώς να φτάσετε</h2>
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="card-elegant p-6">
                <h3 className="font-heading mb-3 text-gradient-brand">{faq.question}</h3>
