                ...
                <section className="section-padding bg-muted/20">
                    <div className="container-max max-w-4xl space-y-12">
                        ...
                        <div>
                            ...
                            <div className="prose prose-lg max-w-none text-muted-foreground text-center md:text-left">
                                <p>
                                    Για ζευγάρια που αναζητούν <strong>δεξίωση γάμου για 50 άτομα στην Αθήνα ή την Αττική</strong>, το Κτήμα Ωρίων στην Κερατέα μπορεί να φιλοξενήσει περίπου 50–350 καλεσμένους. Σε μια επίσκεψη συζητάμε τη διάταξη των τραπεζιών, τον χώρο για cocktail και χορό, καθώς και το κατάλληλο plan B ανάλογα με την εποχή. Ο συνδυασμός εσωτερικού και εξωτερικού χώρου δίνει ευελιξία για μικρό γάμο ή μεγαλύτερη δεξίωση.
                                </p>
                            </div>
                        </div>
                        <div>
