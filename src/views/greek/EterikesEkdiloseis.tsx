        ...
        <section className="section-padding bg-gradient-to-b from-brand-main/10 to-background">
          <div className="container-max text-center">
            ...
            <div className="max-w-4xl mx-auto space-y-6 text-lg md:text-xl leading-relaxed text-muted-foreground">
              ...
              <p>
                Η εμπειρία των συνεργατών μας, η αφοσίωση μας στη συνέπεια και η επιμονή μας στη λεπτομέρεια, 
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="font-heading mb-3">Συνεπής Εκτέλεση</h3>
                    <p className="text-muted-foreground">
                      Αφοσίωση στη συνέπεια και επιμονή στη λεπτομέρεια για άψογα αποτελέσματα.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-heading mb-3">Ευελιξία & Προσαρμογή</h3>
                    <p className="text-muted-foreground">
                      Εμπειρία και ευελιξία για την εκπλήρωση όλων των προϋποθέσεων επιτυχίας.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-heading mb-3">Σύγχρονες Εγκαταστάσεις</h3>
                    <p className="text-muted-foreground">
