...
export default function KtimataVaptisisAthina() {
  ...
  return <Layout>
      <SEO title="Κτήμα για Βάπτιση στην Αθήνα | Κτήμα Ωρίων Κερατέα" description="Όμορφοι υπαίθριοι χώροι για βάπτιση στο Κτήμα Ωρίων. Οικογενειακά μενού, σκιασμένοι κήποι, κοντά σε εκκλησίες. Ρωτήστε για πακέτα ημέρας & φωτογραφίες." canonical="/el/ktimata-vaptisis-athina" keywords="κτήμα βάπτισης αθήνα, κτήματα για βάπτιση, χώρος βάπτισης αττική, βάπτιση δίπλα στη θάλασσα, κτήμα βάπτισης κερατέα" />
