...
export default function AgiosPanteleimonasKeratea() {
  ...
  return <Layout>
    <SEO title="Άγιος Παντελεήμονας Κερατέα – Παραδοσιακή Τελετή Γάμου" description="Τελέστε τον γάμο σας στον Άγιο Παντελεήμονα Κακής Θάλασσας. 8,6 χλμ από Κτήμα Ωρίων. Παραδοσιακή εκκλησία με ιστορία. Κλείστε ημερομηνία!" canonical="/el/ekklisies/agios-panteleimonas-keratea" keywords="αγιος παντελεημονας κερατεα, γαμος κερατεα, εκκλησια κερατεα, παραδοσιακος γαμος αττικη" lang="el" />
