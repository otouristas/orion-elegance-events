...
export default function Dexiosi() {
  ...
  return (
    <Layout>
      <SEO 
        title="Δεξίωση | Κτήμα Ωρίων – Χώρος Δεξιώσεων Κερατέα"
        description="Διοργανώστε την τέλεια δεξίωση στο Κτήμα Ωρίων. Κομψός εσωτερικός χώρος και μαγευτικός κήπος στην Κερατέα για γάμους, βαπτίσεις και εκδηλώσεις."
        canonical="/dexiosi"
        keywords="δεξίωση γάμου, δεξίωση βάπτισης, χώρος δεξιώσεων κερατέα, κέντρα δεξιώσεων αττική"
      />
      <div className="pt-20">
        {/* Hero Section */}
