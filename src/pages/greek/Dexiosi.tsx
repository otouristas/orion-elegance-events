...
export default function Dexiosi() {
  ...
  return (
    <Layout>
      <SEO 
        title="Δεξίωση Γάμου & Βάπτισης | Κτήμα Ωρίων Κερατέα"
        description="Μοναδικές δεξιώσεις στο Κτήμα Ωρίων Κερατέα: εξωτερικός χώρος με θέα, κλιματιζόμενη αίθουσα, 100+ θέσεις parking. Αποκλειστική χρήση χώρου. Κλείστε ξενάγηση!"
        canonical="/dexiosi"
        keywords="δεξίωση γάμου κερατεα, δεξίωση βάπτισης αττικη, χώρος δεξιώσεων, κέντρα δεξιώσεων, δεξίωση γάμου, γαμήλια δεξίωση"
      />
      <div className="pt-20">
        {/* Hero Section */}
