  ...
  return (
    <Layout>
      <SEO 
        ...
        description="Μοναδικές δεξιώσεις δίπλα στη θάλασσα. Μενού από 50€/άτομο, open bar, διακόσμηση, τούρτα. Δείτε πακέτα & τιμές."
        canonical="/dexiosi"
        keywords="δεξίωση γάμου κερατεα, δεξίωση βάπτισης αττικη, χώρος δεξιώσεων, κέντρα δεξιώσεων"
      />
      <div className="pt-20">
        {/* Hero Section */}
