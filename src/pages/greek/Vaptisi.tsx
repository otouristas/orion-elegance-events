...
export default function Vaptisi() {
  ...
  const baptismFAQs = [
    { question: "Τι περιλαμβάνει η βαπτιστική δεξίωση;", answer: "Η βαπτιστική δεξίωση περιλαμβάνει catering με ειδικό παιδικό μενού, διακόσμηση, εξυπηρέτηση, και τη χρήση όλων των χώρων μας (εσωτερικός, εξωτερικός, παιδική χαρά)." },
    { question: "Μπορούμε να κάνουμε βάπτιση το μεσημέρι;", answer: "Φυσικά! Οι βαπτίσεις τελούνται συνήθως το μεσημέρι και ακολουθεί το brunch ή το γεύμα δεξίωσης." },
    ...
    { question: "Ποιες εκκλησίες συνεργάζεστε για βαπτίσεις;", answer: "Συνεργαζόμαστε με 4 πανέμορφες παραθαλάσσιες εκκλησίες κοντά στο κτήμα: Άγιος Αλέξανδρος, Προφήτης Ηλίας, Άγιος Παντελεήμων, και Παναγία Γκαρικά." },
    { question: "Μπορούμε να φέρουμε δικό μας διακοσμητή;", answer: "Απολύτως! Είστε ελεύθεροι να επιλέξετε τους δικούς σας συνεργάτες ή να χρησιμοποιήσετε τις συνεργασίες μας." },
    { question: "Πόσο διαρκεί η δεξίωση;", answer: "Η διάρκεια της δεξίωσης προσαρμόζεται στις ανάγκες σας, συνήθως 4-6 ώρες." },
    { question: "Υπάρχει ειδικό μενού για παιδιά;", answer: "Ναι, προσφέρουμε ειδικά προσαρμοσμένο μενού για παιδιά με υγιεινές και νόστιμες επιλογές." },
    { question: "Μπορούμε να κάνουμε βάπτιση το καλοκαίρι;", answer: "Ναι, ο εξωτερικός σκιερός χώρος και ο κλιματιζόμενος εσωτερικός χώρος μας είναι ιδανικοί για καλοκαιρινές βαπτίσεις." },
    { question: "Τι ώρα αρχίζει συνήθως η δεξίωση;", answer: "Οι βαπτιστικές δεξιώσεις ξεκινούν συνήθως το μεσημέρι (12:00-14:00) μετά την τελετή." },
    { question: "Είναι ο χώρος αποκλειστικός για εμάς;", answer: "Απολύτως! Το κτήμα παραχωρείται αποκλειστικά για την εκδήλωσή σας." }
  ];
  ...
  return (
    <Layout>
      <SEO 
        ...
        description="Ονειρεμένη βάπτιση στο Κτήμα Ωρίων Κερατέα: εξωτερικός χώρος, παιδική χαρά, άνετη στάθμευση, κοντά στη θάλασσα. Εξατομικευμένα πακέτα βάπτισης. Ζητήστε προσφορά!"
        canonical="/vaptisi"
        keywords="βάπτιση κερατέα, κτήμα βάπτισης κερατέα, κτήμα για βάπτιση αττική, δεξίωση βάπτισης, χώρος βάπτισης, πακέτα βάπτισης, βάπτιση δίπλα στη θάλασσα"
      />
      <div className="pt-20">
        {/* Hero Section */}
